...
- Load language-specific vulnerability patterns
...
- Weak random number generation (`Math.random()` for tokens/security IDs)
...
Output the full report with:
- Summary counts table by severity
- Finding cards with File, Line Number, Code Snippet, and Exploit Scenario
